...
public class InternalSpelExpressionParser extends TemplateAwareExpressionParser {
    ...
    @Override
    public SpelExpression doParseExpression(String expressionString, @Nullable ParserContext context)
    ...
    private boolean maybeEatFunctionOrVar() {
        ...
        push(new CustomFunctionReference(functionOrVariableName.stringValue(),
